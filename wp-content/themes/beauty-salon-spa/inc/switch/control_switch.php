 ...
 * Control - Switch.
 *
 * @package Beauty Salon Spa Themes
 */

if( class_exists( 'WP_Customize_Control' ) ) {
	class Beauty_Salon_Spa_Customizer_Customcontrol_Switch extends WP_Customize_Control {
		...
		public function enqueue() {
			...
			wp_enqueue_script( 'beauty-salon-spa-control-switch', trailingslashit( get_template_directory_uri() ) . 'inc/switch/control_switch.js', array( 'jquery' ) );

			wp_enqueue_style( 'beauty-salon-spa-control-switch', trailingslashit( get_template_directory_uri() ) . 'inc/switch/control_switch.css', '', time() );
